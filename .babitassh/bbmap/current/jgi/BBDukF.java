...
//		Shared.READ_BUFFER_LENGTH=rbl0;
	...
	public void process2(long startTime){
		...
		outstream.println("Total Removed:          \t"+readsRemoved+" reads ("+String.format("%.2f",readsRemoved*100.0/readsIn)+"%) \t"+
				basesRemoved+" bases ("+String.format("%.2f",basesRemoved*100.0/basesIn)+"%)");
