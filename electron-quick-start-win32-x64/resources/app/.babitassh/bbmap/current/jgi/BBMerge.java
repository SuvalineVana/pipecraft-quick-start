...
//			}
		...
		if(requireStrictExtensionMatch){requireExtensionMatch=true;}
...
//			r1.setInsert(trueSize);
		...
		private final int processReadPair(final Read r1, final Read r2){
			...
			if(tadpole!=null){
				...
				if(extendRight2>0 && (requireExtensionMatch || bestInsert==RET_AMBIG || bestInsert==RET_NO_SOLUTION)){
					...
					final int bestInsertE=extendAndMerge(r1, r2, extendRight2, extendIterations, true, extendRvec);
					final int extension=extendRvec[0]+extendRvec[1];
	...
	private float pfilterRatio=0.00005f;
...
//	private static boolean OUTPUT_FAILED=true;
	...
	private static String version="8.92";
